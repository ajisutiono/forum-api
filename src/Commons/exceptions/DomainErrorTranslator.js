...
DomainErrorTranslator._directories = {
  ...
  'DETAILED_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mendapatkan detail thread karena properti yang dibutuhkan tidak ada'),
  'DETAILED_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mendapatkan detail thread karena tipe data tidak sesuai'),
  // Comment
  ...
  'DETAILED_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mendapatkan detail comment karena properti yang dibutuhkan tidak ada'),
  'DETAILED_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mendapatkan detail comment karena tipe data tidak sesuai'),
  // Reply
  ...
  'DETAILED_REPLY.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mendapatkan detail reply karena properti yang dibutuhkan tidak ada'),
  'DETAILED_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mendapatkan detail reply karena tipe data tidak sesuai'),
};
